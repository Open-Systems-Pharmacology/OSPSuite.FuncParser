...
[![Build status](https://img.shields.io/github/actions/workflow/status/Open-Systems-Pharmacology/CVODES/build-and-publish.yml?logo=nuget&label=Build%20status)](https://github.com/Open-Systems-Pharmacology/OSPSuite.FuncParser/actions/workflows/build-and-publish.yml)
...
https://img.shields.io/github/actions/workflow/status/Open-Systems-Pharmacology/CVODES/build-and-publish.yml?logo=nuget
